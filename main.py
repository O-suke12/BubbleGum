...
def main():
    ...
    user_input = st.sidebar.text_input(
        "Input(You can type more than one word by separating one word with other with comma)",
        "",
    )
    top_n = st.sidebar.slider(
        "The amount of similar words",
        5,
        100,
        (5),
    )
    annotation = st.sidebar.radio("Annotation", ("On", "Off"))
    ...
    st.header("This is a web app to break filter bubbles in your mind")
